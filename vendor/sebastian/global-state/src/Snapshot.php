...
class Snapshot
{
    ...
    /**
     * Creates a snapshot users-defined constants.
     */
    private function snapshotConstants()
    {
        $constants = \get_defined_constants(true);

        if (isset($constants['users'])) {
            $this->constants = $constants['users'];
        }
    }

    /**
     * Creates a snapshot users-defined functions.
     */
    private function snapshotFunctions()
    {
        $functions = \get_defined_functions();

        $this->functions = $functions['users'];
    }

    /**
     * Creates a snapshot users-defined classes.
     */
    ...
    /**
     * Creates a snapshot users-defined interfaces.
     */
    ...
    /**
     * Creates a snapshot of all static attributes in users-defined classes.
     */
