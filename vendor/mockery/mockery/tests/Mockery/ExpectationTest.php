...
class ExpectationTest extends MockeryTestCase
{
    ...
    public function testAnExampleWithSomeExpectationAmends()
    {
        ...
        $service->shouldReceive('login')->with('users', 'pass')->once()->andReturn(true);
        ...
        $this->assertTrue($service->login('users', 'pass'));
    ...
    public function testAnExampleWithSomeExpectationAmendsOnCallCounts_PHPUnitTest()
    {
        ...
        $service->expects($this->once())->method('login')->with('users', 'pass')->will($this->returnValue(true));
