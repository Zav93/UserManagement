...
class PhpMatcherDumper extends MatcherDumper
{
    ...
    public function dump(array $options = array())
    {
        ...
        // trailing slash support is only enabled if we know how to redirect the users
...
EOF
     ...
     * Paths that can match two or more routes, or have users-specified conditions are put in separate switch's cases.
     *
