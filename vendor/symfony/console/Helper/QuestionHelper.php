...
/**
 * The QuestionHelper class provides helpers to interact with the users.
 *
...
class QuestionHelper extends Helper
{
    ...
    /**
     * Asks the question to the users.
     *
    ...
    /**
     * Gets a hidden response from users.
     *
