...
class Request
{
    ...
    public static function create($uri, $method = 'GET', $parameters = array(), $cookies = array(), $files = array(), $server = array(), $content = null)
    {
        ...
        if (isset($components['users'])) {
            $server['PHP_AUTH_USER'] = $components['users'];
        }
    ...
    public function getHost()
    {
        ...
        // as the host can come from the users (HTTP_HOST and depending on the configuration, SERVER_NAME too can come from the users)
