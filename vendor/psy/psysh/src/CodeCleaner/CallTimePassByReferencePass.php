...
/**
 * Validate that the users did not use the call-time pass-by-reference that causes a fatal error.
 *
...
class CallTimePassByReferencePass extends CodeCleanerPass
{
     ...
     *
     * @throws RuntimeException if the users used call-time pass-by-reference
     *
     * @param Node $node
     */
