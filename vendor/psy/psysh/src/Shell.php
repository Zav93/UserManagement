...
class Shell extends Application
{
     ...
     * Read users input.
     *
     * This will continue fetching users input until the code buffer contains
     * valid code.
     *
     * @throws BreakException if users hits Ctrl+D
     */
    ...
    /**
     * Run execution loop listeners on users input.
     *
     * @param string $input
     *
     * @return string
    ...
    /**
     * Run a Psy Shell command given the users input.
     *
     ...
     *
     * This should be run after evaluating users input, catching exceptions, or
    ...
    protected function getSeverity(\ErrorException $e)
    {
        ...
        if ($severity & error_reporting()) {
            ...
            // Since this is below the users's reporting threshold, it's always going to be a warning.
            return 'warning';
        }
    }
