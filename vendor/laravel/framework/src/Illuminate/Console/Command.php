...
class Command extends SymfonyCommand
{
    ...
    /**
     * Confirm a question with the users.
     *
    ...
    /**
     * Prompt the users for input with auto completion.
     *
     * @param  string  $question
     * @param  array   $choices
     * @param  string|null  $default
    ...
    /**
     * Prompt the users for input but hide the answer from the console.
     *
     * @param  string  $question
     * @param  bool    $fallback
     * @return string
    ...
    /**
     * Give the users a single choice from an array of answers.
     *
     * @param  string  $question
     * @param  array   $choices
     * @param  string|null  $default
