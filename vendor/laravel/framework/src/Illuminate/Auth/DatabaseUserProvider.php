...
class DatabaseUserProvider implements UserProvider
{
    ...
    /**
     * Create a new database users provider.
     *
    ...
    public function retrieveByCredentials(array $credentials)
    {
        ...
        // Then we can execute the query and, if we found a users, return it in a
        // generic "users" object that will be utilized by the Guard instances.
        ...
        // Now we are ready to execute the query to see if we have an users matching
